...
#endif
static const char *ng0 = "C:/Users/18960/Desktop/class/p7/NPC/NPC.v";
...
LAB13:    t237 = *((unsigned int *)t4);
    t238 = (~(t237));
    t239 = *((unsigned int *)t29);
    t240 = (t238 || t239);
    if (t240 > 0)
        goto LAB14;
...
LAB20:    t242 = (t0 + 4312);
    ...
    t246 = *((char **)t245);
    memcpy(t246, t3, 8);
    xsi_driver_vfirst_trans(t242, 0, 31);
    t247 = (t0 + 4216);
    *((int *)t247) = 1;
...
LAB16:    xsi_vlog_unsigned_bit_combine(t3, 32, t33, 32, t241, 32);
    goto LAB20;
...
LAB29:    t64 = (t0 + 1208U);
    ...
    t67 = ((char*)((ng4)));
    memset(t69, 0, 8);
    xsi_vlog_unsigned_lshift(t69, 32, t68, 32, t67, 32);
    memset(t70, 0, 8);
...
LAB46:    t107 = ((char*)((ng1)));
    ...
    *((unsigned int *)t111) = (t118 & 15U);
    t119 = *((unsigned int *)t109);
    *((unsigned int *)t109) = (t119 & 15U);
    xsi_vlogtype_concat(t106, 32, 32, 4U, t111, 4, t110, 26, t108, 1, t107, 1);
    goto LAB47;
...
LAB70:    memcpy(t124, t161, 8);

LAB71:    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t75, 32, t106, 32, t124, 32);
    goto LAB54;
...
LAB83:    if (*((unsigned int *)t187) > 0)
        goto LAB84;

LAB85:    if (*((unsigned int *)t162) > 0)
        goto LAB86;

LAB87:    memcpy(t161, t198, 8);

LAB88:    goto LAB66;

LAB67:    xsi_vlog_unsigned_bit_combine(t124, 32, t156, 32, t161, 32);
    goto LAB71;

LAB69:    memcpy(t124, t156, 8);
    goto LAB71;
...
LAB80:    t191 = (t0 + 1048U);
    ...
    t191 = ((char*)((ng3)));
    memset(t193, 0, 8);
    xsi_vlog_unsigned_add(t193, 32, t192, 32, t191, 32);
    goto LAB81;
...
LAB102:    if (*((unsigned int *)t199) > 0)
        goto LAB103;

LAB104:    memcpy(t198, t236, 8);

LAB105:    goto LAB83;

LAB84:    xsi_vlog_unsigned_bit_combine(t161, 32, t193, 32, t198, 32);
    goto LAB88;

LAB86:    memcpy(t161, t193, 8);
    goto LAB88;
...
LAB97:    t229 = (t0 + 2168U);
    ...
    t229 = ((char*)((ng3)));
    memset(t231, 0, 8);
    xsi_vlog_unsigned_add(t231, 32, t230, 32, t229, 32);
    goto LAB98;

LAB99:    t236 = ((char*)((ng8)));
    goto LAB100;

LAB101:    xsi_vlog_unsigned_bit_combine(t198, 32, t231, 32, t236, 32);
    goto LAB105;

LAB103:    memcpy(t198, t231, 8);
    goto LAB105;
...
extern void work_m_00000000002788700315_0757879789_init()
{
	static char *pe[] = {(void *)Cont_34_0,(void *)Cont_43_1};
	xsi_register_didat("work_m_00000000002788700315_0757879789", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002788700315_0757879789.didat");
